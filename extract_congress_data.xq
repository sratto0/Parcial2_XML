...
let $congressName := string($congressInfo/name)
let $congressNumber := string($congressInfo/number)
let $startYear := string($congressInfo/startYear)
let $endYear := string($congressInfo/endYear)
let $url := string($congressInfo/url)
